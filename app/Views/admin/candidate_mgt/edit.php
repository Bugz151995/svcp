<a href="#" class="btn btn-sm btn-outline-primary d-none" id="editCandidateBtn" data-bs-toggle="modal" data-bs-target="#editCandidate"><i class="fas fa-camera-retro fa-fw me-2"></i></a>

<!-- Modal -->
<div class="modal fade" id="editCandidate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editCandidateLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <?= form_open('admin/candidate/update') ?>
      <?= csrf_field() ?>
      ...
      <div class="modal-body">    
        <div class="row g-3 g-lg-4 mb-3">
          <div class="form-group col-sm-6">
            ...
            <input type="text" name="fname" id="fname" value="<?= set_value('fname', $candidate['fname'])?>" placeholder="Firstname here..." class="form-control form-control-sm">
          ...
          <div class="form-group col-sm-6">
            ...
            <input type="text" name="mname" id="mname" value="<?= set_value('mname', $candidate['mname'])?>" placeholder="Middlename here..." class="form-control form-control-sm">
            <?php if(isset($validation)): ?>
          ...
          <div class="form-group col-sm-6">
            ...
            <input type="text" name="lname" id="lname" value="<?= set_value('lname', $candidate['lname'])?>" placeholder="Lastname here..." class="form-control form-control-sm">
            <?php if(isset($validation)): ?>
          ...
          <div class="form-group col-sm-6">
            ...
            <input type="text" name="suffix" id="suffix" value="<?= set_value('suffix', $candidate['suffix'])?>" placeholder="Suffix here..." class="form-control form-control-sm">
            <?php if(isset($validation)): ?>
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    document.getElementById('editCandidateBtn').click();
  })
</script>